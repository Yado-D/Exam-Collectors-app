                  ...
                  children: [
                    Expanded(
                      child: _buildActionButton(
                          context, "Pause", ColorCollections.TextColor, Colors.white,
  ...
  Widget _buildBreakTimeWidget(
    ...
    return Column(
      children: [
        ...
        _buildActionButton(
            context, 'Start New Session', ColorCollections.TextColor, Colors.white,
            onTap: () {
        ...
        _buildActionButton(
            ...
            onTap: () {
              Navigator.pushNamedAndRemoveUntil(
                  context, "/home_page", (predicate) => true);
            }),
      ],
    );
  }
