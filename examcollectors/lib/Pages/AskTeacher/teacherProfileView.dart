  ...
  Future<void> _saveRatingToDatabase(double rating) async {
    try {
      await FirebaseFirestore.instance
          ...
          .doc(widget.teacherInfo['userEmail'])
          .update(
        {
            ...
            children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount:
                              widget.teacherInfo["achievement"]?.length ??
                                  0, // Safely check for null or empty
                          itemBuilder: (context, i) {
                            var achievements = widget.teacherInfo["achievement"]
                                as List<dynamic>?;
                            ...
                            return Card(
                              ...
                              child: Center(
                                child: ReusableText(
                                  TextString: achievements[i] ??
                                      '', // Safely access the achievement item
                                  FontSize: 16,
                                  TextFontWeight: FontWeight.w700,
                                ),
                              ),
              ...
              Row(
                ...
                children: [
                            ...
                            Row(
                              ...
                              children: List.generate(
                                ...
                                (index) => InkWell(
                                  onTap: () {
                                    _updateRating(
                                        0.5); // Full star rating (1 to 5)
                                  },
                                  onLongPress: () {
                                    // Handle half-star rating
                                    _updateRating(
                                        0.5); // Half star rating (1.5, 2.5, 3.5, etc.)
                                  },
                                  child: Icon(
                                    Icons.star,
                                    size: 18,
                  ...
                  InkWell(
                    onTap: () {
                      // if (widget.teacherInfo['userName'] ==
                      //     userData!.userName) {
                      //   Navigator.of(context).push(MaterialPageRoute(
                      //       builder: (context) => lookAskedUserList(
